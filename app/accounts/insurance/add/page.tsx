      ...
      <main className="flex-1 px-4 py-6 md:px-8 md:py-8">
        <div className="mx-auto flex w-full max-w-xl flex-col gap-6">
          <div>
            ...
            <h1 className="text-2xl font-semibold tracking-tight text-foreground">Add insurance policy</h1>
            <p className="mt-1 text-sm text-muted-foreground">Life, health, auto, or home insurance.</p>
          </div>
          <AddInsuranceForm />
        </div>
      </main>
