...
export default function OfficeDaysPage() {
  ...
  return (
    <main className="flex-1 px-4 py-6 md:px-8 md:py-8">
      <div className="mx-auto flex w-full max-w-xl flex-col gap-6">
        <PageHeader
          title="Office Days"
          subtitle="Tap a day to mark it as an office day."
          action={<MonthPicker value={month} onChange={setMonth} options={officeMonthOptions()} />}
        />
