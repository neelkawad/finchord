...
type Tab = 'appointments' | 'days' | 'documents'
  ...
  return (
    <main className="flex-1 px-4 py-6 md:px-8 md:py-8">
      <div className="flex w-full max-w-xl flex-col gap-6">
        <PageHeader title="Organizer" subtitle="Office days, appointments, and document expiries in one place." />
        ...
        {tab === 'appointments' ? <AppointmentsTab /> : tab === 'days' ? <OfficeDaysTab /> : <DocumentsTab />}
      </div>
    </main>
  )
}
